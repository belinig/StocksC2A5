...
namespace StocksC2A5.Controllers
{
    [Authorize]
    ...
    public class QuoteApiController : Controller
    {
        ...
        public IActionResult DeleteWatchlist(string watchlistid)
        {
            ...
            bool result = Data.MongoDBDataAccess.DeleteWatchlist(name, watchlistid);
;
        ...
        public IActionResult SaveWatchlist([FromBody]Watchlist watchlist)
        {
            ...
            try
            {
                success = Data.MongoDBDataAccess.SaveWatchlist(null, name, watchlist);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetWatchlists()
        {
            string name = User?.Identity.Name;
            var email = HttpContext.User.FindFirst(ClaimTypes.Email)?.Value;
            List<string> watchlists = Data.MongoDBDataAccess.GetWatchlists(null, name);
