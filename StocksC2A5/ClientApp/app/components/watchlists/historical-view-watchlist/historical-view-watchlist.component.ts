...
import { Sort, MatSortHeaderIntl, MatSort, MatSortHeader } from '@angular/material';
...
export class HistoricalViewWatchlistComponent extends ViewWatchlistComponent  {
    ...
    @Input()
    public watchlists: string[]|null = null;
    ...
    public watchlist: IWatchlistQuote|null = null;
    ...
    @Input()
    public initWatchlistName: string | null = null;
    ...
    @ViewChildren(MatSortHeader) sortHeader: QueryList<MatSortHeader>|null = null;
    @ViewChild("open") sortHeaderOpen: MatSortHeader|null = null;
    @ViewChild("previousClose") sortHeaderPreviousClose: MatSortHeader|null = null;
    
    constructor(wService: WatchlistDataService,
        router: Router,
        route: ActivatedRoute,
        sortHeaderIntl: MatSortHeaderIntl) {
    ...
    public changeWatchlist(selectedWatchlist: any) {
        ...
        let qdate: Date = this.quotedate ? new Date(this.quotedate) : new Date();
    ...
    public getWatchlistHistorical(watchlistName: string, quotedate: Date) {
        ...
        this.wService.getWatchlistHistoricalData(watchlistName, quotedate).subscribe(result => {
            ...
            if (this.selectedWatchlistName == result.watchlist.name && result) {
                this.watchlist = result;
                if (this.watchlist && this.watchlist.watchlist && this.watchlist.watchlist.symbols) {
                    let index: number = 0;
