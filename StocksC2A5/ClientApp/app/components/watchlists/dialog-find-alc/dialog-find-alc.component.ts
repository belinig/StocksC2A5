...
export class FindAlcStockDialog implements OnInit {
    stockCodeName: string|null = null;
    pageSize: number = 5;
    searching = false;
    searchFailed = false;
    ...
    stockFilterBy: Subject<string>|null = null;
    ...
    constructor(public dialogRef: MatDialogRef<FindAlcStockDialog>, private wService: WatchlistDataService) { }
